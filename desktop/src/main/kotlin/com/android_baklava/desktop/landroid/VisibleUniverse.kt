 ...
 * Modifications:
 * - Removed Android-specific dependencies (android.util.Log)
...
val STAR_POINTS = 16 // Android SDK_INT placeholder for desktop
...
fun ZoomedDrawScope.drawLanding(landing: Landing) {
    ...
    if (true) { // flagFlag() - desktop always shows flag
